...
export class AppComponent {
  ...
  constructor(){
    this.restaurants = [
      new Restaurant("Boxer Ramer", "Asian", "1234 Example st", '$$', [1], 0),
      new Restaurant("Le Pigeon", "French", "231 Fake st", '$$$$', [1] , 1),
      new Restaurant("Piazza Italia", "Italian", "1232 Marshall st", '$$$', [1], 2)
    ];
  }
